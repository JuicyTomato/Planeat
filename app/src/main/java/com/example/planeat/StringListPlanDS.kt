...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "settings")        //diverso tra dataStores

class StringListPlanDS(context: Context) {
    private val dataStore: DataStore<Preferences> = context.dataStore

    companion object {
        val STRING_LIST_KEY = stringPreferencesKey("string_list")       //diverso tra dataStores
    }
