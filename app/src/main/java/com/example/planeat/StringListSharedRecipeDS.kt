...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "shared_recipe")        //diverso tra dataStores

class StringListSharedRecipeDS(context: Context) {
    private val dataStore: DataStore<Preferences> = context.dataStore

    companion object {
        val STRING_LIST_KEY = stringPreferencesKey("shared_recipe_list")       //diverso tra dataStores
    }
